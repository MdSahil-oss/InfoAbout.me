...
declare class Appwrite {
    ...
    account: {
         ...
         * @returns {Promise}
         */
        getLogs: (limit?: number | undefined, offset?: number | undefined) => Promise<Models.LogList>;
        /**
         * Update Account Name
         *
    ...
    database: {
         ...
         * @returns {Promise}
         */
        listDocuments: <Document_1 extends Models.Document>(collectionId: string, queries?: string[] | undefined, limit?: number | undefined, offset?: number | undefined, cursor?: string | undefined, cursorDirection?: string | undefined, orderAttributes?: string[] | undefined, orderTypes?: string[] | undefined) => Promise<Models.DocumentList<Document_1>>;
        /**
         * Create Document
         *
         ...
         * @returns {Promise}
         */
        createDocument: <Document_2 extends Models.Document>(collectionId: string, documentId: string, data: object, read?: string[] | undefined, write?: string[] | undefined) => Promise<Document_2>;
        /**
         * Get Document
         *
         ...
         * @returns {Promise}
         */
        updateDocument: <Document_4 extends Models.Document>(collectionId: string, documentId: string, data: object, read?: string[] | undefined, write?: string[] | undefined) => Promise<Document_4>;
        /**
         * Delete Document
         *
    ...
    functions: {
         ...
         * @returns {Promise}
         */
        listExecutions: (functionId: string, limit?: number | undefined, offset?: number | undefined, search?: string | undefined, cursor?: string | undefined, cursorDirection?: string | undefined) => Promise<Models.ExecutionList>;
        /**
         * Create Execution
         *
         ...
         * @returns {Promise}
         */
        createExecution: (functionId: string, data?: string | undefined, async?: boolean | undefined) => Promise<Models.Execution>;
        /**
         * Get Execution
         *
    ...
    storage: {
         ...
         * @returns {Promise}
         */
        listFiles: (bucketId: string, search?: string | undefined, limit?: number | undefined, offset?: number | undefined, cursor?: string | undefined, cursorDirection?: string | undefined, orderType?: string | undefined) => Promise<Models.FileList>;
        /**
         * Create File
         *
         ...
         * @returns {Promise}
         */
        createFile: (bucketId: string, fileId: string, file: File, read?: string[] | undefined, write?: string[] | undefined, onProgress?: (progress: UploadProgress) => void) => Promise<Models.File>;
        /**
         * Get File
         *
         ...
         * @returns {Promise}
         */
        updateFile: (bucketId: string, fileId: string, read?: string[] | undefined, write?: string[] | undefined) => Promise<Models.File>;
        /**
         * Delete File
         *
    ...
    teams: {
         ...
         * @returns {Promise}
         */
        list: (search?: string | undefined, limit?: number | undefined, offset?: number | undefined, cursor?: string | undefined, cursorDirection?: string | undefined, orderType?: string | undefined) => Promise<Models.TeamList>;
        /**
         * Create Team
         *
         ...
         * @returns {Promise}
         */
        create: (teamId: string, name: string, roles?: string[] | undefined) => Promise<Models.Team>;
        /**
         * Get Team
         *
         ...
         * @returns {Promise}
         */
        getMemberships: (teamId: string, search?: string | undefined, limit?: number | undefined, offset?: number | undefined, cursor?: string | undefined, cursorDirection?: string | undefined, orderType?: string | undefined) => Promise<Models.MembershipList>;
        /**
         ...
         * @returns {Promise}
         */
        createMembership: (teamId: string, email: string, roles: string[], url: string, name?: string | undefined) => Promise<Models.Membership>;
        /**
         * Get Team Membership
         *
